...
// node_modules/@chakra-ui/theme-tools/node_modules/@chakra-ui/utils/dist/chakra-ui-utils.esm.js
var import_lodash = __toESM(require_lodash());

// node_modules/@chakra-ui/theme-tools/node_modules/framesync/dist/es/on-next-frame.js
...
// node_modules/@chakra-ui/theme-tools/node_modules/framesync/dist/es/create-render-step.js
...
// node_modules/@chakra-ui/theme-tools/node_modules/framesync/dist/es/index.js
var maxElapsed = 40;
...
var isDark = function isDark2(color) {
  return function(theme) {
    return tone(color)(theme) === "dark";
  };
};
var isLight = function isLight2(color) {
  return function(theme) {
    return tone(color)(theme) === "light";
  };
};
var transparentize = function transparentize2(color, opacity) {
  return function(theme) {
    var raw = getColor(theme, color);
    return new TinyColor(raw).setAlpha(opacity).toRgbString();
  };
};
var whiten = function whiten2(color, amount) {
  return function(theme) {
    var raw = getColor(theme, color);
    return new TinyColor(raw).mix("#fff", amount).toHexString();
  };
};
var blacken = function blacken2(color, amount) {
  return function(theme) {
    var raw = getColor(theme, color);
    return new TinyColor(raw).mix("#000", amount).toHexString();
  };
};
var darken = function darken2(color, amount) {
  return function(theme) {
    var raw = getColor(theme, color);
    return new TinyColor(raw).darken(amount).toHexString();
  };
};
var lighten = function lighten2(color, amount) {
  return function(theme) {
    return new TinyColor(getColor(theme, color)).lighten(amount).toHexString();
  };
};
var contrast = function contrast2(fg, bg) {
  return function(theme) {
    return readability(getColor(theme, bg), getColor(theme, fg));
  };
};
var isAccessible = function isAccessible2(textColor, bgColor, options) {
  return function(theme) {
    return isReadable(getColor(theme, bgColor), getColor(theme, textColor), options);
  };
};
var complementary = function complementary2(color) {
  return function(theme) {
...
var createBreakpoints = function createBreakpoints2(config) {
  warn({
    condition: true,
